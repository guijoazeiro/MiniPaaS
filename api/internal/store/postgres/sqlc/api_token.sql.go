...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, user_id, name, token_hash, token_prefix, scopes, expires_at, revoked_at, last_used_at, created_at
`
...
SELECT id, user_id, name, token_hash, token_prefix, scopes, expires_at, revoked_at, last_used_at, created_at FROM api_tokens
WHERE token_hash = $1
LIMIT 1
`
